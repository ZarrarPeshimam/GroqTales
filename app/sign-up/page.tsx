...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] -mt-6 -mb-6 flex items-center justify-center bg-[#0a0a0c] text-neutral-200 py-12">
      
      {/* Abstract Corporate/CRM style background */}
      ...
      <div className="w-full max-w-lg px-6 relative z-10 flex flex-col">
        ...
        <p className="mt-8 text-center text-sm text-neutral-500 font-medium pb-8 border-transparent">
          ...
          <Link href="/sign-in" className="text-white hover:text-neutral-300 transition-colors ml-1 font-semibold">
            Sign In Here
          </Link>
        </p>
